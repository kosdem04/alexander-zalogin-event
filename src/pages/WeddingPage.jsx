...
export default function WeddingPage() {
  return (
    <PageShell className={styles.page}>
        ...
        <div className={styles.container}>
          <div className={styles.formGrid}>
            <LeadForm
              ...
              note="Расскажите о дате, площадке и желаемом настроении вечера, и я предложу формат, который подойдет именно вашей паре."
            />
            <div className={styles.sideFacts}>
              <h3>Что важно в заявке</h3>
              <ul>
                <li>Дата и площадка свадьбы.</li>
                <li>Количество гостей и формат вечера.</li>
                <li>Ваши пожелания по атмосфере и музыкальному ритму.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <CTASection
        eyebrow="Для пары"
        title="Современная свадьба без пошлости"
